...
/// @nodoc
mixin _$ProductCubitState {
  ProductRequest get dto => throw _privateConstructorUsedError;
  List<ComboBox> get comboBoxes => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $ProductCubitStateCopyWith<ProductCubitState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductCubitStateCopyWith<$Res> {
  factory $ProductCubitStateCopyWith(
          ProductCubitState value, $Res Function(ProductCubitState) then) =
      _$ProductCubitStateCopyWithImpl<$Res, ProductCubitState>;
  @useResult
  $Res call({ProductRequest dto, List<ComboBox> comboBoxes});

  $ProductRequestCopyWith<$Res> get dto;
}

/// @nodoc
class _$ProductCubitStateCopyWithImpl<$Res, $Val extends ProductCubitState>
    implements $ProductCubitStateCopyWith<$Res> {
  _$ProductCubitStateCopyWithImpl(this._value, this._then);
...
class __$$StateImplCopyWithImpl<$Res>
    extends _$ProductCubitStateCopyWithImpl<$Res, _$StateImpl>
...
class _$StateImpl implements _State {
  ...
  @override
  String toString() {
    return 'ProductCubitState(dto: $dto, comboBoxes: $comboBoxes)';
  }
...
abstract class _State implements ProductCubitState {
  const factory _State(
      {required final ProductRequest dto,
